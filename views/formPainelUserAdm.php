<?php ini_set('default_charset','UTF-8'); if(!isset($_SESSION)){session_start();} if( (!isset ($_SESSION['email'])== true) || (!isset ($_SESSION['password']) == true ) || ($_SESSION['admin'] == 0)) {session_destroy(); header('location:../views/formLogin.php');}
    $nome = $_SESSION['nameUser']; //recebe a variavel que recebe o nome
                                    ...
                                    <form class="form-horizontal" role="form" action="../formViewsDB/formPainelUserCRUD.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-control-static" style="margin-top: -7px;">
                                                    ...
                                                    <div class="radio custom-radio radio-inline" style="margin-left: -10px;">
                                                        <label><input name="radioCheCpfCnpj" type="radio" value="0" <?php echo ($_SESSION[ 'icTipoUser']=="0" ) ? "checked" : null; ?> ><span class="fa fa-circle"></span> Juridica</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">CELULAR 1</label>
                                                <div class="col-sm-3">
                                                    <input name="telCelular1" id="telCelular1" type="tel" class="form-control round" placeholder="(00) 0000-00000" maxlength="11" value="<?php echo $_SESSION['telCelular1'];?>">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="telCelular2" type="tel" class="form-control round" placeholder="(00) 00000-0000" maxlength="11"  value="<?php echo $_SESSION['telCelular2'];?>">
                                            </div>
                                            <label class="col-sm-2 control-label">WHATSAPP</label>
                                            <div class="col-sm-3">
                                                <div class="checkbox switch">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="telCelular3" type="tel" class="form-control round" placeholder="(00) 00000-0000" maxlength="11" value="<?php echo $_SESSION['telCelular3'];?>">
                                            </div>
                                            <label class="col-sm-2 control-label"> <span class="fa fa-whatsapp" aria-hidden="true">WHATSAPP</label>
                                            <div class="col-sm-3">
                                                <div class="checkbox switch">
                                                    <label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input name="telFixo" type="tel" class="form-control round" placeholder="(00) 0000-0000" maxlength="10" value="<?php echo $_SESSION['telFixo'];?>"/>
                                            </div>
                                        </div>
                                        <!--Dados do Endereço-->
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">COD. IBGE</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="checkbox switch">
                                                    <label>
                                                        <input name="checkboxAdmin" type="checkbox" <?php echo ($_SESSION['admin'] == "1") ? "checked" : null; ?> />
                                                        <span class="cs-place">
                                                            <span class="fa fa-check cs-handler"></span>
                                                        </span>
                                                    </label>
